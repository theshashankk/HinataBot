...
ELEVATED_USERS_FILE = os.path.join(os.getcwd(), "hinataBot/elevated_users.json")
...
#  ❍ /broadcashinataBotroups*:* Broadcasts too all groups
...
# *Global Blue Text*
#  ❍ /gignoreblue*:* <word>*:* Globally ignorea bluetext cleaning of saved word across hinataBot.
