...
def kang(update: Update, context: CallbackContext):
    ...
    if msg.reply_to_message:
        ...
        if not is_animated:
            ...
            kang_file.download("kangsticker.hinataBots")
        ...
        if not is_animated:
            ...
            try:
                context.bot.add_sticker_to_set(
                    user_id=user.id,
                    name=packname,
                    hinataBots_sticker=open("kangsticker.hinataBots", "rb"),
                    emojis=sticker_emoji,
                )
                msg.reply_text(
                    f"Sticker successfully added to [pack](t.me/addstickers/{packname})"
    ...
    try:
        ...
        elif os.path.isfile("kangsticker.hinataBots"):
            os.remove("kangsticker.hinataBots")
    except:
        pass
...
def makepack_internal(
    ...
    try:
        ...
        if hinataBots_sticker:
            success = context.bot.create_new_sticker_set(
                user.id,
                packname,
                f"{name}s animated kang pack" + extra_version,
                hinataBots_sticker=hinataBots_sticker,
                emojis=emoji,
            )
