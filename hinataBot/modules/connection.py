...
import hinataBot.modules.sql.connection_sql as sql
from hinataBot import dispatcher, DRAGONS, DEV_USERS
from hinataBot.modules.helper_funcs import chat_status
