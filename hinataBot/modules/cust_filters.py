...
from hinataBot import dispatcher, LOGGER, DRAGONS
from hinataBot.modules.disable import DisableAbleCommandHandler
from hinataBot.modules.helper_funcs.handlers import MessageHandlerChecker
from hinataBot.modules.helper_funcs.chat_status import user_admin
from hinataBot.modules.helper_funcs.extraction import extract_text
from hinataBot.modules.helper_funcs.filters import CustomFilters
from hinataBot.modules.helper_funcs.misc import build_keyboard_parser
from hinataBot.modules.helper_funcs.msg_types import get_filter_type
...
from hinataBot.modules.sql import cust_filters_sql as sql
                        ...
                        if excp.message == "Unsupported url protocol":
                            try:
                                send_message(
                                    ...
                                    "Telegram doesn't support buttons for some protocols, such as hinataBot://. Please try "
                                    "again...",
                                )
                            except BadRequest as excp:
                                LOGGER.exception("Error in filters: " + excp.message)
...
def get_exception(excp, filt, chat):
    if excp.message == "Unsupported url protocol":
        return "You seem to be trying to use the URL protocol which is not supported. Telegram does not support key for multiple protocols, such as hinataBot: //. Please try again!"
    elif excp.message == "Reply message not found":
        return "noreply"
    else:
