...
from hinataBot import DRAGONS, dispatcher
...
from hinataBot.helper_extra.admin_rights import (
    user_can_pin,
    user_can_promote,
    user_can_changeinfo,
)

from hinataBot.modules.helper_funcs.extraction import (
    extract_user,
    extract_user_and_text,
)
from hinataBot.modules.log_channel import loggable
from hinataBot.modules.helper_funcs.alternate import send_message
...
*Admins only:*
 ...
 ❍ /sehinataBottitle <newtitle>*:* Sets new chat title in your group.
 ❍ /sehinataBotpic*:* As a reply to file or photo to set group profile pic!
...
CHAT_PIC_HANDLER = CommandHandler("sehinataBotpic", setchatpic, filters=Filters.group)
DEL_CHAT_PIC_HANDLER = CommandHandler(
    "delgpic", rmchatpic, filters=Filters.group)
SETCHAT_TITLE_HANDLER = CommandHandler(
    "sehinataBottitle", setchat_title, filters=Filters.group
)
