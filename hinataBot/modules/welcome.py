...
import hinataBot.modules.sql.welcome_sql as sql
import hinataBot
from hinataBot import (
    DEV_USERS,
    LOGGER,
    OWNER_ID,
    DRAGONS,
...
from hinataBot.modules.helper_funcs.misc import build_keyboard, revert_buttons
from hinataBot.modules.helper_funcs.msg_types import get_welcome_type
from hinataBot.modules.helper_funcs.string_handling import (
    escape_invalid_curly_brackets,
    markdown_parser,
)
from hinataBot.modules.log_channel import loggable
from hinataBot.modules.sql.global_bans_sql import is_user_gbanned
        ...
        if user.id == new_mem.id:
            if should_mute:
                ...
                if welc_mutes == "strong":
                    ...
                    new_join_mem = f'<a href="hinataBot://user?id={user.id}">{html.escape(new_mem.first_name)}</a>'
...
*Admins only:*
 ...
 ❍ /sehinataBotoodbye <sometext>*:* set a custom goodbye message. If used replying to media, uses that media.
 ❍ /resetwelcome*:* reset to the default welcome message.
 ❍ /resehinataBotoodbye*:* reset to the default goodbye message.
...
SET_GOODBYE = CommandHandler("sehinataBotoodbye", set_goodbye, filters=Filters.group)
RESET_WELCOME = CommandHandler("resetwelcome", reset_welcome, filters=Filters.group)
RESET_GOODBYE = CommandHandler("resehinataBotoodbye", reset_goodbye, filters=Filters.group)
