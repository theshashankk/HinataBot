...
from hinataBot.modules import ALL_MODULES
from hinataBot.modules.helper_funcs.chat_status import is_user_admin
from hinataBot.modules.helper_funcs.misc import paginate_modules
...
hinata_IMG = "https://telegra.ph/file/7e61fe06a9c02747249c4.jpg"

DONATE_STRING = """No need to donate hinata just keep supporting"""
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("hinataBot.modules." + module_name)
...
@run_async
def hinata_about_callback(update, context):
    query = update.callback_query
    if query.data == "hinataBot_":
        query.message.edit_text(
            text=""" ℹ️ I'm *Hinata*, a powerful group management bot built to help you manage your group easily.
                 ...
                 \nHere is the [💾Repository](https://github.com/theshashankk/HinataBot).
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..🤗 I'm *yone*
                 \nHere is the [Source Code](https://github.com/theshashankk/HinataBot) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
