...
buttons = [
    ...
    [
        ...
        InlineKeyboardButton(text="Coffin Bots", popup=f"𝗕𝗢𝗧 𝗕𝗬 𝗧𝗘𝗔𝗠 𝗖𝗢𝗙𝗙𝗜𝗡\n𝙲𝙾𝙵𝙵𝙸𝙽 𝚇 𝙼𝚄𝚂𝙸𝙲\n𝙷𝙸𝙽𝙰𝚃𝙰 𝙱𝙾𝚃"
        ),
    ],
    [
...
def main():
    ...
    about_callback_handler = CallbackQueryHandler(hinata_about_callback, pattern=r"hinataBot_")
