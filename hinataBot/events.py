...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        import importlib
        import hinataBot.events

        path = Path(f"hinataBot/modules/{shortname}.py")
        name = "hinataBot.modules.{}".format(shortname)
        ...
        mod.hinataBot = hinataBot
        mod.tbot = telethn
        mod.logger = logging.getLogger(shortname)
        spec.loader.exec_module(mod)
        sys.modules["hinataBot.modules." + shortname] = mod
        print("Successfully imported " + shortname)


path = "hinataBot/modules/*.py"
