...
import Hinatabot.modules.sql.global_bans_sql as gban_sql
import Hinatabot.modules.sql.users_sql as user_sql
from Hinatabot import DEV_USERS, OWNER_ID, dispatcher
from Hinatabot.modules.helper_funcs.chat_status import dev_plus
...
def dbcleanup(update: Update, context: CallbackContext):
    ...
    buttons = [[InlineKeyboardButton("Support Chat", url="https://t.me/coffinxsupport")]]
