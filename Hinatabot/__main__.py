...
from Hinatabot import (ALLOW_EXCL, CERT_PATH, DONATION_LINK, LOGGER,
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("hentai.modules." +
                                              module_name)
...
if __name__ == '__main__':
    LOGGER.info("Hinata is ready to rock: " + str(ALL_MODULES))
