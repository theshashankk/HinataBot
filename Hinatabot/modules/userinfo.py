...
from Hinatabot import (DEV_USERS, OWNER_ID, DRAGONS, DEMONS, TIGERS, WOLVES,
                          INFOPIC, dispatcher, sw)
from Hinatabot.__main__ import STATS, TOKEN, USER_INFO
import Hinatabot.modules.sql.userinfo_sql as sql
...
from Hinatabot.modules.sql.afk_sql import is_afk, check_afk_status
from Hinatabot.modules.sql.users_sql import get_user_num_chats
from Hinatabot.modules.sql.feds_sql import get_user_fbanlist
from Hinatabot.modules.helper_funcs.chat_status import sudo_plus
from Hinatabot.modules.helper_funcs.extraction import extract_user
from Hinatabot import telethn as SaitamaTelethonClient, TIGERS, DRAGONS, DEMONS
